...
import com.app.goodwalls.component.AppBarLayoutBehavior;
import com.app.goodwalls.component.RtlViewPager;
...
import com.app.goodwalls.fragment.FragmentCategory;
import com.app.goodwalls.fragment.FragmentFavorite;
import com.app.goodwalls.fragment.FragmentTabLayout;
import com.app.goodwalls.fragment.FragmentWallpaper;
...
public class MainActivity extends AppCompatActivity implements DefaultLifecycleObserver {
        ...
        public Fragment getItem(int position) {
            if (Config.SET_CATEGORY_AS_MAIN_SCREEN) {
                if (position == 0) {
                    ...
                    if (Config.ENABLE_WALLPAPER_MENU_WITH_SWIPE_TAB_LAYOUT) {
    ...
    private void showDialog(boolean show) {
        if (show) {
            ...
            Tools.postDelayed(() -> {
                lyt_dialog_exit.setVisibility(View.INVISIBLE);
