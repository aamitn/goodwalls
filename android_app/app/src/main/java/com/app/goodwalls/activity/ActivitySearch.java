...
import static com.app.goodwalls.util.Constant.EXTRA_OBJC;
...
import com.app.goodwalls.adapter.AdapterCategory;
import com.app.goodwalls.adapter.AdapterSearch;
import com.app.goodwalls.adapter.AdapterWallpaper;
import com.app.goodwalls.callback.CallbackCategory;
import com.app.goodwalls.callback.CallbackWallpaper;
import com.app.goodwalls.component.ItemOffsetDecoration;
import com.app.goodwalls.database.prefs.AdsPref;
import com.app.goodwalls.database.prefs.SharedPref;
import com.app.goodwalls.model.Category;
...
public class ActivitySearch extends AppCompatActivity {
    ...
    private void initComponent() {
        ...
        radioGroupSearch.setOnCheckedChangeListener((radioGroup, i) -> {
            if (i == R.id.radio_button_wallpaper) {
                requestSearchWallpaper();
                recyclerViewWallpaper.setVisibility(View.VISIBLE);
                recyclerViewCategory.setVisibility(View.GONE);
                if (adapterSearch.getItemCount() <= 0) {
            ...
            } else if (i == R.id.radio_button_category) {
                requestSearchCategory();
                recyclerViewWallpaper.setVisibility(View.GONE);
                recyclerViewCategory.setVisibility(View.VISIBLE);
                if (adapterSearch.getItemCount() <= 0) {
    ...
    private void setOnWallpaperClickListener(boolean click) {
        if (click) {
            adapterWallpaper.setOnItemClickListener((view, obj, position) -> {
                Tools.openWallpaperDetailActivity(this, wallpapers, position);
